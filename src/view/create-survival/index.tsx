...
export const CreateSurvivalPage: NextPage = () => {
  ...
  const { mutateAsync: createBot, isLoading: createBotLoading } = api.bot.create.useMutation()
  const { mutateAsync: createSim, isLoading: simLoading } = api.simulate.simulate.useMutation()
      ...
      <main className="bg-[#DBD7C6] text-black">
        <MainLayout>
          <div className="mt-4 flex items-center space-x-2 p-4">
            ...
            <div>
              <Link
                className="cursor-pointer rounded-md bg-[#B1A6A0] p-2 text-black"
          ...
          <div className="bg-[#DBD7C6] p-4 pb-16">
            <div className="mt-4 space-y-4 rounded-lg bg-[#B1A6A0] p-4">
              {createBotLoading || simLoading ? (
                <div className="flex h-auto w-full justify-center">
                  <Image src="/image/Loading.gif" alt="loading" width={590} height={154} />
                </div>
              ) : (
                <>
                  {/*  */}
                  ...
                  <div>
                    Warning!: By creating new survivor you are deploying a new contract. Any changes to the contract
                    cannot be made until redeployed again blah blah blah
                  </div>
